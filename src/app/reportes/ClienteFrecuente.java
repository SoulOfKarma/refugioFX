...
public class ClienteFrecuente {
     ...
     public void reporteClientes(Date fechaI, Date fechaT)
    {
        try {
	    ...
	    Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@172.105.148.58:1521/dbrefugio", "refugio", "refugio");
            ...
            JasperPrint j = JasperFillManager.fillReport(ClassLoader.getSystemResourceAsStream("app/reportes/ClienteFrecuente.jasper"), parametro, conn);
            JasperViewer jv = new JasperViewer(j,false);
            jv.setTitle("Reporte Frecuente");
            jv.setVisible(true);
